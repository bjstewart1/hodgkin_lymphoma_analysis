...
annotations <- c(#b cells
                      ...
                      "2" = "naive_b",
                      "1" = "memory_b",
                      "17" = "germinal_centre_b",
                      '14,3' = "proliferating_b",
                      "19" = "plasmablast",
                    #t cells
                 #innate lymphocytes
                 "13,2" = "ILC",
                 ...
                 "13,0" = "NK_2",
                "5" = "CD8_Tem",
                "14,2" = "CD8_Tem_proliferating",
                 "14,1" = "CD8_Tdys",
                 "12" = "CD8_Tem_terminal",
                 "14,0" = "CD4_Tdys_proliferating",
                 "8" = "CD4_Tdys", #numerous checkpoints
                 "3" = "CD4_Tfh", #CXCL13 & CXCR5 expression
                 "10" = "CD4_Treg", #FOXP3 
